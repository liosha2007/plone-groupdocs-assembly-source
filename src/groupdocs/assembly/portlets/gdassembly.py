...
logger = logging.getLogger('groupdocs.assembly')
...
class Assignment(base.Assignment):
    ...
    header = _(u"title_gdassembly_portlet", default=u"GroupDocs Assembly portlet")
    fileid = u""
    width = u""
    height = u""
    omit_border = False
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('gdassembly.pt')
    ...
    def transformed(self, mt='text/x-html-safe'):
        """Transform imput data to get iframe code for GroupDocs Embedded Assembly.
        """
        frame_source = '<iframe src="http://dev-apps.groupdocs.com/assembly2/questionnaire-assembly/' + self.data.fileid + '" frameborder="' + (str(1) if self.data.omit_border else str(0)) +  '" width="' + self.data.width + '" height="' + self.data.height + '"></iframe>'
...
class AddForm(base.AddForm):
    ...
    description = _(u"description_assembly_portlet",
